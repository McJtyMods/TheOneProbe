...
import mcjty.theoneprobe.lib.transfer.fluid.FluidTransferable;
...
public class FluidTileDataHandler {
    public static final ResourceLocation PACKET_ID = TheOneProbe.asResource("fluid_tile_handler_data");

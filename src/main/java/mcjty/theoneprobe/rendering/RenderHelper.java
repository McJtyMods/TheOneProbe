...
public class RenderHelper {
    ...
    public static void renderEntity(Entity entity, GuiGraphics graphics, int x, int y, int width, int height, float scale) {
        ...
        try {
            ...
            graphics.submitEntityRenderState(state, scale, offset, rotation, null, x, y, x + width, y + height);
        } catch (Exception e) {
    ...
    public static void drawThickBeveledBox(GuiGraphics graphics, int x1, int y1, int x2, int y2, int thickness,
    ...
    public static boolean renderItemStack(Minecraft mc, ItemRenderer itemRenderer, ItemStack stack, GuiGraphics graphics,
        ...
        try {
            ...
            graphics.renderItemDecorations(mc.font, stack, x, y, amount);
            return true;
        } catch (Exception e) {
    ...
    public static int renderText(Minecraft mc, GuiGraphics graphics, int x, int y, String text) {
